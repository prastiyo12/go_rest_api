...
// @Accept			json
// @Produce		json
// @Param			sign-up	body	core.SignUpInput	true	"SignUpInput"
...
func SignUpUser(c *fiber.Ctx) error {
	...
	errors := core.ValidateStruct(payload)
	if errors != nil {
	...
	return c.Status(fiber.StatusCreated).JSON(fiber.Map{"status": "success", "data": fiber.Map{"user": core.FilterUserRecord(&newUser)}})
}
...
// @Accept			json
// @Produce		json
// @Param			login	body	core.SignInInput	true	"Login Input"
